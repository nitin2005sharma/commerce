        ...
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-12 sm:h-16">
            ...
            <div className="hidden lg:flex items-center gap-5 text-sm font-medium text-gray-700">
              ...
              <Link href="/goals" className="transition hover:text-indigo-600">
                Goals
              </Link>
              <Link href="/assistant" className="transition hover:text-emerald-600">
                Shopping Help
              </Link>
            </div>
                  ...
                  >
                    {user?.avatar ? (
                      <div className="w-7 h-7 rounded-full bg-gray-200 overflow-hidden border border-gray-300">
                        <SafeImage
                          src={user.avatar}
                          fallbackSrc={generateUserAvatar(user.name)}
                          alt="User Profile"
                          width={28}
                          height={28}
                      ...
                      <div className="w-[35px] h-[35px] rounded-full overflow-hidden border border-gray-300">
                        <SafeImage
                          ...
                          fallbackSrc={generateUserAvatar(user?.name || "User")}
                          alt="User Profile"
                          width={35}
                          height={35}
                          className="rounded-full object-cover w-full h-full"
