...
const TransactionsDashboard = () => {
  ...
  const handleUpdateStatus = (transaction: any) => {
    const shipment = transaction?.order?.shipment;
    const latestTrackingEvent = transaction?.order?.trackingEvents?.[0];
    ...
    setTrackingForm({
      ...
      deliveryDate: shipment?.deliveryDate
        ? new Date(shipment.deliveryDate).toISOString().slice(0, 16)
        : "",
    });
  ...
  const confirmStatusUpdate = async () => {
    ...
    try {
      const res = await updateTransactionStatus({
        ...
        deliveryDate: trackingForm.deliveryDate
          ? new Date(trackingForm.deliveryDate).toISOString()
          : undefined,
      }).unwrap();
      console.log("res => ", res);
        ...
        <div>
          ...
          <div className="mb-4">
            ...
            <input
              ...
              placeholder="Ex: Kolkata sorting hub"
          ...
          <div className="mb-4">
            ...
            <textarea
              ...
              placeholder="Ex: Package scanned at the local delivery center"
              rows={3}
              className="w-full rounded-md border border-gray-300 p-2"
            />
          </div>
