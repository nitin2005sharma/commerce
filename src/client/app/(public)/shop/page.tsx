          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <Link
                  href="/goals"
                  className="mt-2 inline-flex items-center gap-2 text-sm font-medium text-indigo-600"
                >
                  Want a ready-made plan? View shopping plans
                </Link>
                <Link
                  href="/assistant"
                  className="mt-2 inline-flex items-center gap-2 text-sm font-medium text-emerald-600"
                >
                  Need help deciding? Open shopping help
                </Link>
              </div>
