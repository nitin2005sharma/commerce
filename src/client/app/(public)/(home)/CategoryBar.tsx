...
import { generatePlaceholderImage } from "@/app/utils/placeholderImage";
import {
  Smartphone,
  Monitor,
  Headphones,
  ...
  return (
    <section className="pt-10">
      <div className="container mx-auto px-4">
        ...
        >
          <p className="text-xs font-semibold uppercase tracking-[0.24em] text-[#7c6f64] mb-3">
            Shop By Category
          </p>
          ...
          <p className="max-w-3xl text-sm leading-7 text-slate-600">
            Prefer to look around yourself? Start with a category and go straight
            to the products.
          </p>
        </motion.div>
        ...
        >
          <Link
            href="/shop"
            className="inline-flex items-center gap-2 bg-slate-900 hover:bg-slate-800 text-white font-semibold py-3 px-6 rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200"
          >
